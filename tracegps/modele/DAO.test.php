...
// Dernière mise à jour : 8/5/2019 par dP
?>
<!DOCTYPE html>
<html>
<head>
...
// // modifié par dP le 12/8/2018
 ...
 $unUtilisateur = new Utilisateur(0, "toto", "mdputilisateur", "delasalle.sio.eleves@gmail.com", "5566778899", 2, date('Y-m-d H:i:s', time()), 0, null);
 $ok = $dao->creerUnUtilisateur($unUtilisateur);
 $dao->modifierMdpUtilisateur("toto", "mdpadmin");
