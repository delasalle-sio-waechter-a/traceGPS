...
// Dernière mise à jour : 02/12/2022 par Erwan
...
{	$msg = "Erreur : méthode HTTP incorrecte.";
    ...
    else
    {
        ...
        {
           //Vérification que le pseudo de l'utilisateur destinataire existe bien dans la base de données 
           $ok = $dao->existePseudoUtilisateur($pseudoDestinataire);
           if (! $ok)
           {
            ...
            {   //On récupère les informations pour le mail 
                ...
                //puis on construit le mail et on l'envoie
                ...
                $contenuMail .= "Voici les informations le concernant : \n\n";
                ...
                $contenuMail .= $ADR_SERVICE_WEB."?a=".$mdp."&b=".$pseudoDestinataire."&c=".$utilisateurDemandeur->getPseudo()."&d=1 \n\n"; 
                $contenuMail .="Pour refuser la demande, cliquez sur ce lien : \n";
                $contenuMail .= $ADR_SERVICE_WEB."?a=".$mdp."&b=".$pseudoDestinataire."&c=".$utilisateurDemandeur->getPseudo()."&d=0 \n\n";
                ...
                if ( ! $ok ) {
                    ...
                    $msg = $utilisateurDestinataire->getPseudo()." va recevoir un courriel avec votre demande.";
                    $code_reponse = 200;
                }  
            }
        } 
